# Metals Hub – Physical Portfolio Guide
**Version 0.0.2**

Metals Hub is a local-first secure physical ledger. It is designed to track fine weight calculations, real-time spot valuations, transactions, and secure storage.
...
## 1. Walkthrough: Segment-by-Segment Functions
